...
GPS flickering issue: DIRECT FIX - Disabled automatic GPS map recentering completely. GPS only updates marker position. No animations on map moves to eliminate flickering.