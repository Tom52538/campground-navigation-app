...
GPS flickering issue: FIXED - Implemented smart map following. GPS updates only move the user marker, map only recenters when marker goes off-screen. No more constant map recentering causing flickering.